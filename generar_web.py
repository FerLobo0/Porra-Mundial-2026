...
HOJAS_PARTICIPANTES = ["FER", "PEDRO", "CAÑAS", "AGUDO","CUBANO","ANTO","TREBO","SANTI"]

# Nombre para mostrar y nombre de archivo HTML para cada hoja
PARTICIPANTES_INFO = {
    "FER":   {"display": "Fer",    "archivo": "fer.html"},
    "PEDRO": {"display": "Pedro",  "archivo": "pedro.html"},
    "CAÑAS": {"display": "Cañas",  "archivo": "canas.html"},
    "AGUDO": {"display": "Agudo",  "archivo": "agudo.html"},
    "CUBANO": {"display": "Cubano",  "archivo": "cubano.html"},
    "ANTO": {"display": "Anto",  "archivo": "anto.html"},
    "TREBO": {"display": "Trebo",  "archivo": "trebo.html"},
    "SANTI": {"display": "Santi",  "archivo": "santi.html"},
